...
namespace Assets.Scripts.Classes
{
	public class PunishmentTask : MonoBehaviour
	{
		...
		{
			"You have arrived at punishment task.",
			"Here you will LOSE money at incentive tasks!",
			"Your reaction time shall be recorded.",
			"There are two different cues representing two different trials.",
			"This box represents incentive cue, i.e. punishment",
			"This box represents nonincentive cue, i.e. no punishment",
		...
		private void Start()
		{
			...
			_settings = GlobalSettings.Gs != null
				? GlobalSettings.Gs.PunishmentSettings
				: new TaskSettings(2000, TaskType.Punishment, 20);
