...
{
	public class ResultsDisplayButton : MonoBehaviour
	{
		...
		public void OnValueChanged()
		{
			...
			{
				case IntervalType.MinValue:
					SettingsHandler.SetSpriteField(SpriteTypes.Correct, SettingsType.DisplayIntervalMin, _newValue);
					SettingsHandler.SetSpriteField(SpriteTypes.Incorrect, SettingsType.DisplayIntervalMin, _newValue);
					break;
				case IntervalType.MaxValue:
					SettingsHandler.SetSpriteField(SpriteTypes.Correct, SettingsType.DisplayIntervalMax, _newValue);
					SettingsHandler.SetSpriteField(SpriteTypes.Incorrect, SettingsType.DisplayIntervalMax, _newValue);
					break;
				default:
					throw new ArgumentOutOfRangeException();
			}
