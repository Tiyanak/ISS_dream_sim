...
public class PunishmentFlashing : MonoBehaviour {
    ...
    private int punishmentCount = 20;
    private int nonPunishmentCount = 80;
    ...
    public void Flash()
    {
        if (!isFlashing)
        {
            showSquare = MapSquares.PickRandomPunishmentSquare((double)punishmentCount / nonPunishmentCount);
